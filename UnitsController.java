...
//import com.dune.game.core.units.PlayerTank;
...
public class UnitsController {
    ...
    public UnitsController(GameController gc) {
        ...
        createPlayerTank(Owner.PLAYER, 50,50);
    }
    ...
    public void createPlayerTank(Owner owner, float x, float y) {
        com.dune.game.core.PlayerTank.setup(owner, x, y);
    }
